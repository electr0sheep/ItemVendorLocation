...
namespace GarlandToolsWrapper
{
    public sealed class WebRequests
    {
        ...
        public static Models.Data GetData()
        {
        ...
        public static List<Models.ItemSearchResult> ItemSearch(string itemName)
        {
            ...
            if (response.StatusCode == HttpStatusCode.OK)
            {
                ...
                //List<Models.ItemSearchResult> serializedResult = serializer.Deserialize<List<Models.ItemSearchResult>>(result);
                return serializedResult;
            }
            else
            {
        ...
        public static Models.ItemDetails GetItemDetails(BigInteger itemId)
        {
            ...
            if (response.StatusCode == HttpStatusCode.OK)
            {
                ...
                //Models.ItemDetails serializedResult = serializer.Deserialize<Models.ItemDetails>(result);
                return serializedResult;
            }
            else
            {
